...
# from gallery_api_impl.env import AZURE_STORAGE_CNN_STR, AZURE_STORAGE_NAME, AZURE_STORAGE_KEY
# from gallery_api_impl.feat.puppy.exceptions import PuppyStorageException
